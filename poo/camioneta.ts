class Camioneta{
    ...
    constructor(paramKilometraje:number,paramModelo:number,paramMarca:string,paramCombustible:string,paramPrecio:number,paramService:boolean){
    ...
    Service():void{
     ...
     let toyota = new Camioneta(14.0000,2019,"toyota","diesel",350.000,false,)
       console.log(toyota);